...
public class EnderOreBlock extends CraftinpeaceModElements.ModElement {
	@ObjectHolder("craftinpeace:ender_ore")
	public static final Block block = null;
	public EnderOreBlock(CraftinpeaceModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EnderDustItem.block, (int) (4)));
		}
	}
	@Override
