...
public class PyriteOreBlock extends CraftinpeaceModElements.ModElement {
	@ObjectHolder("craftinpeace:pyrite_ore")
	public static final Block block = null;
	public PyriteOreBlock(CraftinpeaceModElements instance) {
		super(instance, 51);
	}
