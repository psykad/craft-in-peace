...
public class MarekaniteBlock extends CraftinpeaceModElements.ModElement {
	@ObjectHolder("craftinpeace:marekanite")
	public static final Block block = null;
	public MarekaniteBlock(CraftinpeaceModElements instance) {
		super(instance, 29);
	}
